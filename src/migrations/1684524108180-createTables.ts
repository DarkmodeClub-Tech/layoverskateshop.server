...
export class CreateTables1684524108180 implements MigrationInterface {
    name = 'CreateTables1684524108180'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cart_products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cart_amount" integer NOT NULL, "cartId" uuid, "productId" uuid, CONSTRAINT "PK_3b12299e401712e78753a7b4fec" PRIMARY KEY ("id"))`);
