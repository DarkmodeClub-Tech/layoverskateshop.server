...
export class AlterTables1681218740737 implements MigrationInterface {
    name = 'AlterTables1681218740737'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "addresses" ADD "city" character varying(120) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "addresses" ADD "state" character varying(120) NOT NULL`);
    }
