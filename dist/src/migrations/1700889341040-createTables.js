...
exports.CreateTables1700889341040 = void 0;
class CreateTables1700889341040 {
    constructor() {
        this.name = 'CreateTables1700889341040';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "photos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" character varying(300) NOT NULL, "public_id" character varying NOT NULL, "productId" uuid, "ownerId" uuid, CONSTRAINT "PK_5220c45b8e32d49d767b9b3d725" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE TABLE "cart_products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cart_amount" integer NOT NULL, "requested_colors" text array NOT NULL DEFAULT '{}', "requested_sizes" text array NOT NULL DEFAULT '{}', "cartId" uuid, "productId" uuid, CONSTRAINT "PK_3b12299e401712e78753a7b4fec" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`ALTER TABLE "photos" ADD CONSTRAINT "FK_4e7f1b413734d5424ba9902a185" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "sellers" ADD CONSTRAINT "FK_61c8b0a0c581ab9e176ac6471c8" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_e40a1dd2909378f0da1f34f7bd6" FOREIGN KEY ("sellerId") REFERENCES "sellers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_ff56834e735fa78a15d0cf21926" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_37b1f6f78f0d1870b3b6ab7b40e" FOREIGN KEY ("packagingId") REFERENCES "product_packaging"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "customers" ADD CONSTRAINT "FK_9a1ba71f8651412e2003cfa46d4" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "customers" ADD CONSTRAINT "FK_cca5fdc20671318f60dca2cfb65" FOREIGN KEY ("cartId") REFERENCES "carts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        });
    }
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "customers" DROP CONSTRAINT "FK_cca5fdc20671318f60dca2cfb65"`);
            yield queryRunner.query(`ALTER TABLE "customers" DROP CONSTRAINT "FK_9a1ba71f8651412e2003cfa46d4"`);
            ...
            yield queryRunner.query(`ALTER TABLE "products" DROP CONSTRAINT "FK_ff56834e735fa78a15d0cf21926"`);
            yield queryRunner.query(`ALTER TABLE "products" DROP CONSTRAINT "FK_e40a1dd2909378f0da1f34f7bd6"`);
            ...
            yield queryRunner.query(`ALTER TABLE "sellers" DROP CONSTRAINT "FK_61c8b0a0c581ab9e176ac6471c8"`);
            yield queryRunner.query(`ALTER TABLE "photos" DROP CONSTRAINT "FK_556eedea27ffaf50a4ee0c0a058"`);
            yield queryRunner.query(`ALTER TABLE "photos" DROP CONSTRAINT "FK_4e7f1b413734d5424ba9902a185"`);
...
exports.CreateTables1700889341040 = CreateTables1700889341040;
